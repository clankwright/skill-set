...
- [easy] [should-fix] 27.12 `skills/dev/sst-dev-review/SKILL.md` gate bypass in d1a3a7e: retroactive sst-sanitize-transferable run needed; record "Sanitize: must-fix=N" — review of d1a3a7e (group with gate-bypass)
- [easy] [should-fix] 27.13 `skills/dev/sst-dev-cycle/SKILL.md:§5` gate lacks "inline not sufficient" clause; two consecutive bypasses; add explicit prohibition + proprietary mirror — review of d1a3a7e (group with gate-bypass)
