...
- [easy] [should-fix] 27.14 `skills/dev/sst-dev-cycle/SKILL.md §5` gate bypass in 7d7eb87: retroactive sst-sanitize-transferable run needed; record "Sanitize: must-fix=N" — review of 7d7eb87
