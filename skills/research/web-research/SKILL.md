...
- **Output dir**: `<project>/data/web-research/` by default. Override via the project's harness-instructions file. Reports are written as `<utc>_<query-hash>.md`.
...
Save the report to `<project>/data/web-research/<utc>_<short-slug>.md`. The slug is a 3-5-word kebab-case version of the topic. If the dir doesn't exist, create it.
