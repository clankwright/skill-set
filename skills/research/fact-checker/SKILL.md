...
- **Output dir**: `<project>/data/fact-checker/` by default. Reports as `<utc>_<batch-hash>.md`.
...
Write to `<project>/data/fact-checker/<utc>_<batch-hash>.md`:
...
- **Don't add safety/ethics commentary.** The fact-checker reports facts; editorial framing belongs to the calling skill.
