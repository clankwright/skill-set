...
- **Output dir**: `<project>/data/sst-literary-critic/` for saved feedback reports. Reports as `<utc>_<draft-hash>.md`.
...
Save to `<project>/data/sst-literary-critic/<utc>_<draft-slug>.md`:
