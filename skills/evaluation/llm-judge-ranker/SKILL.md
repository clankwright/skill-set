...
- **Output dir**: `<project>/data/llm-judge-ranker/<run-id>/` where `<run-id>` is either user-supplied or auto-generated as `<utc>_<short-uuid>`. Inside:
